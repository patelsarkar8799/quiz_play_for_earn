package com.harsh.myapplication.SpinWheel
...
import com.harsh.myapplication.SpinWheel.LuckyWheelUtils.convertDpToPixel
import com.harsh.myapplication.SpinWheel.PielView.PieRotateListener
...
class LuckyWheelView : RelativeLayout, PieRotateListener {
    ...
    fun setLuckyRoundItemSelectedListener(listener: (Any) -> Unit) {
        this.mLuckyRoundItemSelectedListener
    }
    ...
    private fun init(ctx: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            mTopTextSize = typedArray.getDimensionPixelSize(
                R.styleable.LuckyWheelView_lkwTopTextSize, convertDpToPixel(
                    25f,
                    context
                ).toInt()
            )
            mSecondaryTextSize = typedArray.getDimensionPixelSize(
                R.styleable.LuckyWheelView_lkwSecondaryTextSize, convertDpToPixel(
                    10f,
                    context
                ).toInt()
            )
            ...
            mTopTextPadding = typedArray.getDimensionPixelSize(
                R.styleable.LuckyWheelView_lkwTopTextPadding, convertDpToPixel(
                    22f,
                    context
                ).toInt()
